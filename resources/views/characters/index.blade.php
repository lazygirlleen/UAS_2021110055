    ...
    <table class="table mb-5">
        ...
        <tbody  class="text-gray-700">
            ...
            <tr>
                ...
                <td class="font-medium text-gray-900">{{ $character->nation }}</td>
                ...
                <td>
                    <a href="{{ route('characters.edit', $character) }}" class="btn btn-primary btn-sm">
                        Edit
                    </a>
            ...
            @empty
            <tr>
                <td colspan="7">No character found.</td>
            </tr>
            @endforelse
        </tbody>
