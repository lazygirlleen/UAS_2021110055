    ...
    <div id="stats" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="card-body">
            <div class="bg-gray-500 rounded-lg transition-transform transform  duration-300 mb-3">
                ...
                <h3 class="mb-4 text-xl font-bold text-green">Characters Wikipedia</h3>
                    <p class="text-gray-700 text-base">See all of the Genshin Impact Character information in our Website.</p>
                </div>
            </div>
            </div>
            </div>
        ...
        <div class="bg-gray-500 rounded-lg transition-transform transform  duration-300 mb-3">
                <div class="p-6">
                    ...
                    <p class="text-gray-700 text-base">See all of the Genshin Impact Weapon information in our Website.</p>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="bg-gray-500 rounded-lg transition-transform transform  duration-300 mb-3">
                <div class="p-6">
                    ...
                    <p class="text-gray-700 text-base">You can top up Blessing of the Welkin Moon and Genesis Crystal in here.</p>
                </div>
            </div>
            </div>
            </div>
        ...
        <div class="bg-gray-500 rounded-lg transition-transform transform  duration-300 mb-3">
                <div class="p-6">
                    ...
                    <p class="text-gray-700 text-base">Got any problem on your game? We can help you.</p>
                </div>
            </div>
        </div>
